...
const myBot = ['u5ea7b17472b7abe5cc4e2f35d46ea07c'];
...
class LINE extends LineAPI {
    ...
    async textMessage(textMessages, seq) {
        ...
        if(txt == 'speed') {
            ...
            await this._sendMessage(seq,'stay nih, lanjutkan');
        ...
        const action = ['gajadi on','gajadi off','usir on','usir off']
        ...
        if(cmd == 'ikut') { //untuk join group pake qrcode contoh: join line://anu/g/anu
